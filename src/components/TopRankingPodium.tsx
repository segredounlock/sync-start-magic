          ...
          {podiumOrder.map((user, displayIndex) => {
            ...
            return (
              <motion.div
                ...
                style={{ width: isCenter ? 100 : 80, flexShrink: 0 }}
              ...
              >
                ...
                >
                  <p className={`flex items-center justify-center gap-1 font-semibold truncate ${isCenter ? "max-w-[140px] md:max-w-[160px] text-sm text-foreground" : "max-w-[100px] md:max-w-[130px] text-xs text-muted-foreground"}`} title={user.nome}>
