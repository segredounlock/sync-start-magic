...
-- Fix reseller_pricing_rules: change from RESTRICTIVE to PERMISSIVE
...
CREATE POLICY "Users can manage own reseller pricing"
ON public.reseller_pricing_rules
FOR ALL
USING (auth.uid() = user_id)
WITH CHECK (auth.uid() = user_id);

CREATE POLICY "Users can view own reseller pricing"
ON public.reseller_pricing_rules
FOR SELECT
USING (auth.uid() = user_id);

-- Also fix other RESTRICTIVE tables that were missed
...
CREATE POLICY "Admins can manage bot_settings" ON public.bot_settings FOR ALL USING (has_role(auth.uid(), 'admin'::text)) WITH CHECK (has_role(auth.uid(), 'admin'::text));
CREATE POLICY "Admins can view bot_settings" ON public.bot_settings FOR SELECT USING (has_role(auth.uid(), 'admin'::text));
...
CREATE POLICY "Admins can manage broadcast_progress" ON public.broadcast_progress FOR ALL USING (has_role(auth.uid(), 'admin'::text)) WITH CHECK (has_role(auth.uid(), 'admin'::text));
CREATE POLICY "Admins can view broadcast_progress" ON public.broadcast_progress FOR SELECT USING (has_role(auth.uid(), 'admin'::text));

DROP POLICY IF EXISTS "Admins can manage notifications" ON public.notifications;
DROP POLICY IF EXISTS "Admins can view notifications" ON public.notifications;
CREATE POLICY "Admins can manage notifications" ON public.notifications FOR ALL USING (has_role(auth.uid(), 'admin'::text)) WITH CHECK (has_role(auth.uid(), 'admin'::text));
CREATE POLICY "Admins can view notifications" ON public.notifications FOR SELECT USING (has_role(auth.uid(), 'admin'::text));
...
CREATE POLICY "Admins can manage operadoras" ON public.operadoras FOR ALL USING (has_role(auth.uid(), 'admin'::text)) WITH CHECK (has_role(auth.uid(), 'admin'::text));
...
CREATE POLICY "Admins can manage pricing rules" ON public.pricing_rules FOR ALL USING (has_role(auth.uid(), 'admin'::text)) WITH CHECK (has_role(auth.uid(), 'admin'::text));
...
CREATE POLICY "Admins can view all profiles" ON public.profiles FOR SELECT USING (has_role(auth.uid(), 'admin'::text));
CREATE POLICY "Resellers can view client profiles" ON public.profiles FOR SELECT USING (reseller_id = auth.uid());
...
CREATE POLICY "Admins can view all roles" ON public.user_roles FOR SELECT USING (has_role(auth.uid(), 'admin'::text));
CREATE POLICY "Only admins can manage roles" ON public.user_roles FOR ALL USING (has_role(auth.uid(), 'admin'::text)) WITH CHECK (has_role(auth.uid(), 'admin'::text));
...
CREATE POLICY "Admins can insert saldos" ON public.saldos FOR INSERT WITH CHECK (has_role(auth.uid(), 'admin'::text));
CREATE POLICY "Admins can update saldos" ON public.saldos FOR UPDATE USING (has_role(auth.uid(), 'admin'::text));
CREATE POLICY "Admins can view all saldos" ON public.saldos FOR SELECT USING (has_role(auth.uid(), 'admin'::text));
...
CREATE POLICY "Admins can manage config" ON public.system_config FOR ALL USING (has_role(auth.uid(), 'admin'::text)) WITH CHECK (has_role(auth.uid(), 'admin'::text));
CREATE POLICY "Admins can view config" ON public.system_config FOR SELECT USING (has_role(auth.uid(), 'admin'::text));
...
CREATE POLICY "Admins can manage telegram_users" ON public.telegram_users FOR ALL USING (has_role(auth.uid(), 'admin'::text)) WITH CHECK (has_role(auth.uid(), 'admin'::text));
CREATE POLICY "Admins can view all telegram_users" ON public.telegram_users FOR SELECT USING (has_role(auth.uid(), 'admin'::text));
...
CREATE POLICY "Admins can view all transactions" ON public.transactions FOR SELECT USING (has_role(auth.uid(), 'admin'::text));
...
CREATE POLICY "Admins can view all recargas" ON public.recargas FOR SELECT USING (has_role(auth.uid(), 'admin'::text));
...
CREATE POLICY "Admins can view all reseller config" ON public.reseller_config FOR SELECT USING (has_role(auth.uid(), 'admin'::text));
CREATE POLICY "Users can manage own config" ON public.reseller_config FOR ALL USING (auth.uid() = user_id) WITH CHECK (auth.uid() = user_id);
